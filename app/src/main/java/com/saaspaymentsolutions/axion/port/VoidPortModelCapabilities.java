...
public final class VoidPortModelCapabilities {
    ...
    private static Capabilities fallbackCapabilities(String providerId, String modelName) {
        ...
        if (lower.contains("deepseek-v4") || lower.contains("deepseek_v4")
                || lower.contains("deepseek v4")) {
            return recognized(modelName, "deepseek-v4", 1_000_000, 32_768,
                    SystemMessageSupport.SYSTEM_ROLE, toolFormat, false,
                    ReasoningCapabilities.thinkTags(true, true, 32_768));
        }
        ...
        if (lower.contains("deepseek")) {
            return recognized(modelName, "deepseek", 64_000, 8_192,
                    SystemMessageSupport.SYSTEM_ROLE, toolFormat, false,
