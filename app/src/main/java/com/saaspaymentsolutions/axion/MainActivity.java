...
public class MainActivity extends BaseAppCompatActivity {
    ...
    private void initViews() {
        ...
        if (drawerAppVersion != null) {
            // Single source of truth: build.gradle versionName (the strings.xml
            // copy is a fallback for previews and gets replaced here).
            drawerAppVersion.setText("v" + BuildConfig.VERSION_NAME);
        }
    }
